...
/// Thin wrapper over the Gemini REST API with Google Search grounding.
/// Uses the built-in `fetch` (Node 22) — no SDK dependency. The key lives in
/// the backend env (`GEMINI_API_KEY`); the client never sees it.
@Injectable()
