...
export const SITE = {
  ...
  tagline: 'Live football, World Cup 2026 brackets, fantasy XI & collectible cards',
  description:
  ...
  playStoreUrl: 'https://play.google.com/store/apps/details?id=com.footballmojo',
  contactEmail: 'support@footballmojo.in',
  privacyEmail: 'privacy@footballmojo.in',
